    ...
    return (
        <div className='page'>
            ...
            <Dialogue
                ...
                messages={[
                    { speaker: 'Doctor', message: 'Great, because we actually have been scanning your vitals since you walked in. You’re clean, although you could probably stand to floss a little more.' }
                ]}
            />
        </div>
    );
