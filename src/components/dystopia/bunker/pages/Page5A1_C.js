    ...
    return (
        <div className='page'>
            ...
            <Dialogue
                ...
                responses={[
                    { link: '/dystopia/5A2', message: '“Recycled air? It almost seems riskier to stay in Districts. Why not go back into the world so that you’re more able to spread out?”' },
