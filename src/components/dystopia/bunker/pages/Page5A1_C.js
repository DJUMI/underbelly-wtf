    ...
    return (
        <div className='page'>
            ...
            <Dialogue
                ...
                bottom={true}
                messages={[
                    { speaker: 'HDS Guard "Moore"', message: 'We rely on recycled air, so if someone has COVID, it’s highly likely that the entire District will get it and wipe out that population. The virus, from our shared observation, mutated last year and has become a complete death sentence.' }
                ]}
                responses={[
