...
const EndDialogue = ({ theme, bottom, buttonPress, short, fast, startDelay, messages, responses }) => {
    ...
    const renderButton = () => {
        ...
        return (
            <div onClick={buttonPress} className='fade-in dialogue__container--icon'>
